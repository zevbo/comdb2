...
If you find yourself altering audited tables often, you can use the `cary_alters_to_audits`.
...
is mostly only useful for type changes, as the data of new columns will not get tracked.
